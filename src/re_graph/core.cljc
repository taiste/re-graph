...
(re-frame/reg-event-fx
 ::mutate
 interceptors
 (fn [{:keys [db dispatchable-event instance-name]} [query-id {:keys [operationName query variables]} callback-event]]
...
(re-frame/reg-event-fx
 ::query
 interceptors
 (fn [{:keys [db dispatchable-event instance-name]} [query-id {:keys [operationName query variables] :as payload} callback-event]]
